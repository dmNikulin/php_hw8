...
class Application {
    ...
    //     $memory_start = memory_get_usage(); //потребление памяти на начало запуска
    //     $result = $this->run();
    //     $memory_end = memory_get_usage();
    //     // добавить проверку опций в config.ini
    //     $this->saveMemoryLog($memory_end - $memory_start); // результат замера
